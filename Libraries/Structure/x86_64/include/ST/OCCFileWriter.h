...
struct ST_API OCCFileWriter
{
    ...
    */
    ...
    /** @brief [Deprecated] Write the provided DeviceMotionEvent to the OCC file.
        @deprecated DeviceMotionEvent is not used on Windows.
    */
    void writeDeviceMotionEvent(const DeviceMotionEvent& deviceMotionEvent);
